...
class UnifiedConversationRequest(BaseModel):
    ...
    PATIENT_PHONE: str = Field(..., min_length=10, max_length=12, description="Patient phone number (10 digits)")
...
class UnifiedConversationResponse(BaseModel):
    ...
    FIN: str = Field(..., description='"true" if conversation ended, "false" if conversation continues')
